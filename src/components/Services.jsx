          ...
          <div className='relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden'>
            ...
            <div className='absolute inset-0 flex flex-col justify-end p-8
              ...
              <p className='body-2 mb-[3rem] text-n-3'>
                Automatically enhance photos using our AI app's photo editing feature. Try it now!
              </p>
            </div>
          </div>
            ...
            <div className='py-12 px-4 xl:px-8'>
              ...
              <ul className='flex items-center justify-between'>
                {brainwaveServicesIcons.map((item, index) => (
                  <li 
                    key={index} className={`rounded-2xl flex items-center justify-center
                    ${index === 2 ? 'w-[3rem] h-[3rem] p-0.3 bg-conc-gradient md:w-[4.5rem] md:h-[4.5rem]' 
